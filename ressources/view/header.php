<DIV class=header>
	...
	<DIV class="header_menu">
		<DIV class="menu_grand_forma">
		 <a class="element_menu" href="../home/home.php"><button class="menu">Accueil </button></a></li>	
		 <a class="element_menu" href="../galerie/galerie.php"><button class="menu">Galerie</button></a> </li>
		 <a class="element_menu" href="../montage/montage.php"><button class="menu">Montage</button></a> </li>
		 <a class="element_menu" href="../user/utilisateur.php"><button class="menu">Mon compte </button></a></li>
		 ...
		 ?></DIV>
                  ...
                  <DIV class="menu_petit_forma"><ul>
                     <li ><img class="img_menu" src="../../ressources/img/icones/menu_deroulant.png" alt="Menu"></li>
                     <li><a class="element_menu" href="../home/home.php">Accueil </a></li>
                     <li><a class="element_menu" href="../galerie/galerie.php">Galerie</a></li>
                     <li><a class="element_menu" href="../montage/montage.php">Montage</a></li>
                     <li><a class="element_menu" href="../user/utilisateur.php">Mon compte </a></li>
