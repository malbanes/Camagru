<?PHP session_start();
	...
	include './fonctions/valide_champ.php';
...
$login= Escape::bdd($_POST['identifiant']);
	...
	{
		$_SESSION['check-password2'] = "mots de passes différents";
		$error++;
		}
}
...
http://localhost:8080/src/user/mail_activation.php?log='.urlencode($login).'&cle='.urlencode($cle).'
